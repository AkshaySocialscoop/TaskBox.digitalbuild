              ...
              <form class="row g-3" method="POST" action="{{ route('user.info') }}" enctype="multipart/form-data">
                ...
                <div class="col-md-12 ">
                      ...
                      <div class="position-relative input-icon">
                        <input type="number" class="form-control" name="phone" id="input15" placeholder="Phone" value="{{ old('phone', $users->userinfo?->phone_number) }}">
                ...
                <div class="col-md-12">
                      <div class="d-md-flex d-grid align-items-center gap-3">
                        <button type="submit" class="btn btn-primary px-4"> {{ $users->userinfo ? 'Update Profile' : 'Save Profile' }}</button> 
                      </div>
                </div>
              </form>
          </div>
